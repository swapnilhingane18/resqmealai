    ...
    <div className="min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-6 space-y-8">
        ...
        <motion.div 
          ...
          className="relative bg-[#111827] border border-[#1f2937] rounded-3xl p-8 sm:p-12 overflow-hidden text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-8 shadow-2xl"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {milestones.map((m, idx) => (
              <motion.div 
                ...
                className={`flex flex-col h-full p-6 rounded-2xl border transition-all ${
                  m.achieved 
              ...
              >
                ...
                {m.achieved && (
                  <div className="mt-4 self-start inline-flex items-center gap-1.5 text-xs font-bold text-primary uppercase tracking-wider bg-primary/10 px-2.5 py-1 rounded">
